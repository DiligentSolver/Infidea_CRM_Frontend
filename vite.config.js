  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        start_url: ".",
        id: ".",
        short_name: "Infidea Admin - E-Commerce Website",
        name: "Infidea Admin | React eCommerce Admin Dashboard",
        description:
          "Infidea Admin : React Grocery & Organic Food Store e-commerce Admin Dashboard",
        icons: [
          {
            src: "favicon.ico",
            sizes: "48x48",
