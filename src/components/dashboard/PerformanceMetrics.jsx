...
const PerformanceMetrics = ({ data = {}, loading = false }) => {
  ...
  const metrics = [
    ...
    {
      title: "Joinings",
      value: parseMetricValue(safeData.joinings),
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      trend: parseMetricValue(trends.joinings),
      color: "bg-purple-50 text-purple-600 dark:bg-purple-900/20 dark:text-purple-400",
      trendColor: parseMetricValue(trends.joinings) >= 0 ? "text-green-500" : "text-red-500"
    },
    {
      title: "Time Spent",
      value: `${safeData.todayTimeSpent || "0h"}`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
