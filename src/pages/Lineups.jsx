            ...
            <Table>
              <TableHeader > 
                ...
                <TableCell className="text-center">
                  ...
                  <TableCell className="text-center" onClick={() => handleSortByField("lineupDate")}>Lineup Date {sortBy === "lineupDate" && (
                    <span className="ml-2 text-gray-500">{sortOrder === "asc" ? "▲" : "▼"}</span>
                  )}</TableCell>
                  <TableCell className="text-center" onClick={() => handleSortByField("interviewDate")}>Interview Date {sortBy === "interviewDate" && (
                    <span className="ml-2 text-gray-500">{sortOrder === "asc" ? "▲" : "▼"}</span>
                  )}</TableCell>
            ...
            <div className="flex flex-1">
              <div className="relative flex items-center shadow-md bg-white dark:bg-gray-700 rounded-l-md w-full sm:w-96">
                ...
                <input
                  ...
                  ref={lineupsRef}
                  onChange={(e) => handleSubmitLineups(e)}
        ...
        <div className="relative max-w-2xl mx-auto p-6 rounded-xl shadow-lg bg-white dark:bg-gray-800 w-full m-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-lg dark:bg-gray-700 bg-gray-100">
              ...
              <dl className="space-y-2">
                ...
                <div className="flex flex-col">
                  <dt className="text-sm dark:text-gray-400 text-gray-500">Company</dt>
                  <dd className="text-base font-medium dark:text-white text-gray-900">
            ...
            <div className="p-4 rounded-lg dark:bg-gray-700 bg-gray-100">
              ...
              <dl className="space-y-2">
                <div className="flex flex-col">
                  <dt className="text-sm dark:text-gray-400 text-gray-500">Process</dt>
                  <dd className="text-base font-medium dark:text-white text-gray-900">
                    {processOptions.find(o => o.value === selectedLineup.process)?.label || selectedLineup.process}
                  </dd>
                </div>
                <div className="flex flex-col">
                  <dt className="text-sm dark:text-gray-400 text-gray-500">Lineup Date</dt>
                  <dd className="text-base font-medium dark:text-white text-gray-900">
                ...
                <div className="flex flex-col">
                  <dt className="text-sm dark:text-gray-400 text-gray-500">Interview Date</dt>
                  <dd className="text-base font-medium dark:text-white text-gray-900">
          ...
          <div className="mt-4 p-4 rounded-lg dark:bg-gray-700 bg-gray-100">
            ...
            <div className="flex items-center space-x-2">
              <span className="text-sm dark:text-gray-400 text-gray-500">Current Status:</span>
